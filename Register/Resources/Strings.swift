...
enum Strings {
    ...
    enum Register {
        ...
        static let appName = "CryptoRadar"
        
        static let title = "Create Account"
        
        static let subtitle = "Start your financial journey with us"
        ...
        static let passwordPlaceholder = "Min. 8 characters"
        
        static let confirmPasswordTitle = "CONFIRM PASSWORD"
        
        static let confirmPasswordPlaceholder = "Repeat your password"
        
        static let createButton = "Create Account"
        
        static let accountQuestion = "Already have an account?"
        
        static let login = "Log In"
        
        static let terms = "By creating an account, you agree to our Terms of Service and Privacy Policy."
